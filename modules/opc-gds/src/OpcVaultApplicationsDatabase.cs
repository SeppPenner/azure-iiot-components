...
namespace Opc.Ua.Gds.Server.Database.OpcVault {
    public class OpcVaultApplicationsDatabase : ApplicationsDatabaseBase {
        ...
        public OpcVaultApplicationsDatabase(IVaultServiceApi OpcVaultServiceClient) {
        ...
        public override NodeId RegisterApplication(
            ...
            var appNodeId = base.RegisterApplication(application);
            ...
            var capabilities = base.ServerCapabilities(application);
...
(Microsoft.Azure.IIoT.OpcUa.Api.Vault.v1.Models.ApplicationType)application.ApplicationType,
        ...
        public override void UnregisterApplication(NodeId applicationId) {
            ...
            var id = OpcVaultClientHelper.GetServiceIdFromNodeId(applicationId, NamespaceIndex);
        ...
        public override ApplicationRecordDataType GetApplication(
            ...
            var appNodeId = OpcVaultClientHelper.GetNodeIdFromServiceId(result.ApplicationId, NamespaceIndex);
