...
namespace Opc.Ua.Gds.Server.OpcVault {
    ...
    public class OpcVaultLoginCredentials : ServiceClientCredentials {
        ...
        private readonly OpcVaultAzureADOptions _azureADOptions;
        ...
        private void InternalInitializeServiceClient() {
            var authenticationContext =
                new AuthenticationContext(
                    (string.IsNullOrEmpty(_azureADOptions.Authority) ? kAuthority : _azureADOptions.Authority) + _azureADOptions.TenantId);
